...
export const mockProducts: ProductDetail[] = [
  ...
  { id: '7', name: 'Espirulina en Polvo', description: 'Microalga con 60% proteína y hierro biodisponible', image_url: 'https://images.unsplash.com/photo-1597045566677-8cf032ed6634?w=400', category: 'Superfoods', rating: 4.6, ingredients: ['Espirulina orgánica deshidratada'], nutritionPer100g: { calories: 290, protein: 57, carbs: 24, fats: 8, fiber: 4 }, benefits: ['Proteína completa', 'Rico en hierro', 'Desintoxicante natural'] },
  { id: '8', name: 'Mantequilla de Almendras', description: 'Crema 100% almendras tostadas sin aditivos ni azúcar', image_url: 'https://images.unsplash.com/photo-1599599810694-b5b37304c041?w=400', category: 'Untables', rating: 4.7, ingredients: ['Almendras tostadas 100%'], nutritionPer100g: { calories: 614, protein: 21, carbs: 19, fats: 56, fiber: 10 }, benefits: ['Vitamina E', 'Magnesio', 'Grasas mono-insaturadas'] },
];
